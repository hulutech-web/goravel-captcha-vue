<template>
  <div class="wg-cap-btn" :style="style">
    <div class="wg-cap-btn__inner" :class="activeClass">
      ...
      <a-modal v-model:open="popoverVisible" :close-on-click-modal="false" append-to-body :center="true" title="人机校验"
        :footer="false" style="top:400px;" width="360px">
        <go-captcha v-model="popoverVisible" width="300px" height="240px" :max-dot="maxDot" :image-base64="imageBase64"
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const activeClass = computed(() => {
      let activeClass = captStatus.value;
